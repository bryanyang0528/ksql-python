...
| Option                 | Type      | Required   | Description                                                  |
+=========================+===========+==========+===============================================================+
| ``ksql_string``         | string    | yes      | KSQL string                                                   |
+-------------------------+-----------+----------+---------------------------------------------------------------+
| ``streams_properties``  | list      | no       | Stream properties. Example: {'auto.offset.reset': 'earliest'} |
+-------------------------+-----------+----------+---------------------------------------------------------------+
...
| Option                  | Type      | Required | Description                                                   |
+=========================+===========+==========+===============================================================+
| ``query_string``        | string    | yes      | KSQL query string                                             |
+-------------------------+-----------+-----------+--------------------------------------------------------------+
| ``encoding``            | string    | no       | Encoding                                                      |
+-------------------------+-----------+-----------+--------------------------------------------------------------+
| ``chunk_size``          | string    | no       | Chunck size                                                   |
+-------------------------+-----------+----------+---------------------------------------------------------------+
| ``streams_properties``  | list      | no       | Stream properties. Example: {'auto.offset.reset': 'earliest'} |
+-------------------------+-----------+----------+---------------------------------------------------------------+
